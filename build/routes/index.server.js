...
const Chat = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<h1 class="${"svelte-r4l776"}">CHAT</h1>

<div class="${"chat-view svelte-r4l776"}" id="${"chat-box"}">${each(chatHistory, (chatMessage, i) => `${chatMessage.user === username
	? `<div class="${"client-message svelte-r4l776"}"><h4 class="${"svelte-r4l776"}">${escape(chatMessage.user)}</h4>
                <textarea${add_attribute("rows", chatMessage.rows, 0)} cols="${"55"}" readonly wrap="${"soft"}" class="${"svelte-r4l776"}">${chatMessage.msg || ""}</textarea>
            </div>`
	: `<div class="${"client-message svelte-r4l776"}" id="${"incoming"}"><h4 class="${"svelte-r4l776"}">${escape(chatMessage.user)}</h4>
                <textarea${add_attribute("rows", chatMessage.rows, 0)} cols="${"55"}" readonly wrap="${"soft"}" class="${"svelte-r4l776"}">${chatMessage.msg || ""}</textarea>
            </div>`}`)}</div>

<div class="${"message-box svelte-r4l776"}"><textarea maxlength="${"240"}" id="${"inputbox"}" type="${"text"}" wrap="${"soft"}" class="${"svelte-r4l776"}">${""}</textarea>
    <svg xmlns="${"http://www.w3.org/2000/svg"}" width="${"49.369"}" height="${"49.384"}" viewBox="${"0 0 49.369 49.384"}" class="${"svelte-r4l776"}"><path id="${"Path_3"}" data-name="${"Path 3"}" d="${"M45.912.281,1.215,26.067a2.316,2.316,0,0,0,.212,4.166l10.251,4.3L39.383,10.117a.578.578,0,0,1,.829.8l-23.231,28.3v7.763a2.314,2.314,0,0,0,4.1,1.524L27.2,41.053l12.016,5.034A2.321,2.321,0,0,0,42.4,44.332L49.345,2.672A2.315,2.315,0,0,0,45.912.281Z"}" transform="${"translate(-0.01 0.031)"}" fill="${"#1e88e5"}"></path></svg></div>`;
});

...
const css$1 = {
	code: "@import url(\"https://fonts.googleapis.com/css2?family=Rubik:wght@300&display=swap\");h1.svelte-bfrt0e.svelte-bfrt0e{margin:0 auto;margin-top:1em;font-size:64px;color:#FFFFFF}.chat-view.svelte-bfrt0e.svelte-bfrt0e{background:#FCFCFC;border-radius:8px;width:100%;height:80%;margin-bottom:2em;box-shadow:0px 6px 6px rgba(0, 0, 0, 0.24);overflow-x:hidden;overflow-y:scroll;scrollbar-color:#dfdfdf #f8f8f8;padding-bottom:1em}.client-message.svelte-bfrt0e.svelte-bfrt0e{background:#e4f4f7;width:80%;min-height:10%;margin:0 auto;margin-top:1em;margin-left:1.6em;border-top-right-radius:4px;border-top-left-radius:0;border-bottom-left-radius:4px;border-bottom-right-radius:4px;padding:0.4em}.client-message.svelte-bfrt0e.svelte-bfrt0e::before{content:\"\";top:-0.4em;left:-1.4em;position:relative;display:block;width:2em;height:1em;background-color:transparent;border-top:20px solid #e4f4f7;border-left:20px solid transparent}.client-message.svelte-bfrt0e.svelte-bfrt0e:nth-child(even){background:#1E88E5;color:#FFFFFF;border-top-right-radius:0;border-top-left-radius:4px;border-bottom-left-radius:4px;border-bottom-right-radius:4px;margin:0 auto;margin-top:1em;margin-right:1.6em}.client-message.svelte-bfrt0e.svelte-bfrt0e:nth-child(even)::before{content:\"\";top:-0.4em;left:42em;position:relative;display:block;width:2em;height:1em;background-color:transparent;border-top:20px solid #1E88E5;border-left:20px solid transparent;transform:rotateY(180deg)}h4.svelte-bfrt0e.svelte-bfrt0e{font-size:1.4em}textarea.svelte-bfrt0e.svelte-bfrt0e{font-size:1.2em;font-family:\"Rubik\";resize:none;border:0;background:inherit}.client-message.svelte-bfrt0e h4.svelte-bfrt0e{margin:0;margin-bottom:0.2em;position:relative;top:-1.6em;left:0.4em}.client-message.svelte-bfrt0e:nth-child(even) h4.svelte-bfrt0e{position:relative;left:28.2em}.client-message.svelte-bfrt0e textarea.svelte-bfrt0e{color:#000000;margin:0;position:relative;top:-1.8em;left:0.4em;border:1px solid red}.client-message.svelte-bfrt0e:nth-child(even) textarea.svelte-bfrt0e{color:#ffffff;position:relative;left:7em}.message-box.svelte-bfrt0e.svelte-bfrt0e{display:flex;flex-direction:row;background:#FCFCFC;border-radius:8px;width:100%;height:6em;box-shadow:0px 6px 6px rgba(0, 0, 0, 0.24)}.message-box.svelte-bfrt0e textarea.svelte-bfrt0e{border:2px solid #d7e3e4;border-radius:8px;background:#EBF8FA;width:90%;height:70%;margin:0.3em;font-size:1.4em;padding:0.3em}.message-box.svelte-bfrt0e svg.svelte-bfrt0e{margin-left:1em;margin-right:1.4em;margin-top:1.4em;cursor:pointer}",
	map: "{\"version\":3,\"file\":\"chat.svelte\",\"sources\":[\"chat.svelte\"],\"sourcesContent\":[\"<script>\\r\\n    import * as animateScroll from \\\"svelte-scrollto\\\";\\r\\n    import { io } from \\\"socket.io-client\\\";\\r\\n    const socket = io(\\\"localhost:3002\\\");\\r\\n\\r\\n    animateScroll.setGlobalOptions({\\r\\n        container: \\\"#chat-box\\\",\\r\\n        offset: \\\"200\\\"\\r\\n    });\\r\\n\\r\\n    export let chatHistory = [];\\r\\n\\r\\n    // Client socket callback that occurs on connection to server. \\r\\n    socket.on(\\\"connect\\\", () => {\\r\\n        // either with send()  socket.send(\\\"Hello!\\\");\\r\\n        // or with emit() and custom event names \\r\\n        //let clientConnected = `CLIENT connected from ...`;\\r\\n        //socket.emit(\\\"clientConnect\\\", clientConnected);\\r\\n        console.log(\\\"Connected to server\\\");\\r\\n\\r\\n        // Client socket listening to specific key emit from server socket\\r\\n        socket.on(\\\"serverMessage\\\", (user, msg, rows) => {\\r\\n            AddMessage(user, msg, rows);\\r\\n            // Force update so reactivity works\\r\\n            chatHistory = chatHistory;\\r\\n            AutoScroll();\\r\\n        });\\r\\n    });\\r\\n\\r\\n    const AddMessage = (user, msg, rows) => {\\r\\n        let chatObj = {\\r\\n            user,\\r\\n            msg,\\r\\n            rows\\r\\n        };\\r\\n        chatHistory.push(chatObj);\\r\\n        // Clientside logging\\r\\n        console.log(\\\"Client Message: \\\" + msg);\\r\\n    }\\r\\n\\r\\n    let username = \\\"Guest\\\";\\r\\n    let newMessage = \\\"\\\";\\r\\n\\r\\n    const CalculateRows = (inputString) => {\\r\\n        let maxrows=30; \\r\\n        let cols = 55;\\r\\n        let arraytxt=inputString.split('\\\\n');\\r\\n        let rows=arraytxt.length; \\r\\n        for (let i=0;i<arraytxt.length;i++) \\r\\n        rows+=parseInt(arraytxt[i].length/cols);\\r\\n\\r\\n        return new Promise((resolve, reject) => {\\r\\n            if (rows>maxrows){\\r\\n                rows=maxrows;\\r\\n            } else{\\r\\n                rows=rows;\\r\\n            }\\r\\n            resolve(rows);\\r\\n        });\\r\\n    }\\r\\n\\r\\n   //socket.emit(\\\"clientMessage\\\", newMessage);\\r\\n    const SendMessage = async() => {\\r\\n        // First calculate size of message\\r\\n        let rows = await CalculateRows(newMessage);\\r\\n\\r\\n        let msgObj = {\\r\\n            username,\\r\\n            newMessage,\\r\\n            rows\\r\\n        };\\r\\n\\r\\n        if(newMessage.length > 240) return console.error(\\\"Message is too long!\\\");\\r\\n\\r\\n        let response = await fetch(\\\"/chat/message\\\", {\\r\\n            method: \\\"POST\\\",\\r\\n            headers: {\\r\\n                \\\"Content-Type\\\": \\\"application/json;charset=utf-8\\\"\\r\\n            },\\r\\n            body: JSON.stringify(msgObj)\\r\\n        });\\r\\n\\r\\n        if(!response.ok) return console.error(\\\"Could not send message!\\\");\\r\\n\\r\\n        let result = response.text();\\r\\n        //console.log(result);\\r\\n        // Reset inputfield value\\r\\n        newMessage = \\\"\\\";\\r\\n    }\\r\\n\\r\\n    // Handles key events on inputbox, like pressing enter to send message\\r\\n    const NewLine = (event) => {\\r\\n        // 13 is the keycode for \\\"enter\\\"\\r\\n        if (event.keyCode == 13 && event.shiftKey) {\\r\\n            // Add line break\\r\\n            //newMessage += \\\"\\\\n\\\";\\r\\n        }\\r\\n        if (event.keyCode == 13 && !event.shiftKey) {\\r\\n            // Send message\\r\\n            SendMessage();\\r\\n        }\\r\\n    }\\r\\n\\r\\n    const AutoScroll = () => {\\r\\n        animateScroll.scrollToBottom();\\r\\n    }\\r\\n\\r\\n\\r\\n    // Reactively update the client-message fields\\r\\n    $: chatHistory;\\r\\n</script>\\r\\n\\r\\n<style>@import url(\\\"https://fonts.googleapis.com/css2?family=Rubik:wght@300&display=swap\\\");\\nh1 {\\n  margin: 0 auto;\\n  margin-top: 1em;\\n  font-size: 64px;\\n  color: #FFFFFF;\\n}\\n\\n.chat-view {\\n  background: #FCFCFC;\\n  border-radius: 8px;\\n  width: 100%;\\n  height: 80%;\\n  margin-bottom: 2em;\\n  box-shadow: 0px 6px 6px rgba(0, 0, 0, 0.24);\\n  overflow-x: hidden;\\n  overflow-y: scroll;\\n  scrollbar-color: #dfdfdf #f8f8f8;\\n  padding-bottom: 1em;\\n}\\n\\n.client-message {\\n  background: #e4f4f7;\\n  width: 80%;\\n  min-height: 10%;\\n  margin: 0 auto;\\n  margin-top: 1em;\\n  margin-left: 1.6em;\\n  border-top-right-radius: 4px;\\n  border-top-left-radius: 0;\\n  border-bottom-left-radius: 4px;\\n  border-bottom-right-radius: 4px;\\n  padding: 0.4em;\\n}\\n\\n.client-message::before {\\n  content: \\\"\\\";\\n  top: -0.4em;\\n  left: -1.4em;\\n  position: relative;\\n  display: block;\\n  width: 2em;\\n  height: 1em;\\n  background-color: transparent;\\n  border-top: 20px solid #e4f4f7;\\n  border-left: 20px solid transparent;\\n}\\n\\n.client-message:nth-child(even) {\\n  background: #1E88E5;\\n  color: #FFFFFF;\\n  border-top-right-radius: 0;\\n  border-top-left-radius: 4px;\\n  border-bottom-left-radius: 4px;\\n  border-bottom-right-radius: 4px;\\n  margin: 0 auto;\\n  margin-top: 1em;\\n  margin-right: 1.6em;\\n}\\n\\n.client-message:nth-child(even)::before {\\n  content: \\\"\\\";\\n  top: -0.4em;\\n  left: 42em;\\n  position: relative;\\n  display: block;\\n  width: 2em;\\n  height: 1em;\\n  background-color: transparent;\\n  border-top: 20px solid #1E88E5;\\n  border-left: 20px solid transparent;\\n  transform: rotateY(180deg);\\n}\\n\\nh4 {\\n  font-size: 1.4em;\\n}\\n\\ntextarea {\\n  font-size: 1.2em;\\n  font-family: \\\"Rubik\\\";\\n  resize: none;\\n  border: 0;\\n  background: inherit;\\n}\\n\\n.client-message h4 {\\n  margin: 0;\\n  margin-bottom: 0.2em;\\n  position: relative;\\n  top: -1.6em;\\n  left: 0.4em;\\n}\\n\\n.client-message:nth-child(even) h4 {\\n  position: relative;\\n  left: 28.2em;\\n}\\n\\n.client-message textarea {\\n  color: #000000;\\n  margin: 0;\\n  position: relative;\\n  top: -1.8em;\\n  left: 0.4em;\\n  border: 1px solid red;\\n}\\n\\n.client-message:nth-child(even) textarea {\\n  color: #ffffff;\\n  position: relative;\\n  left: 7em;\\n}\\n\\n.message-box {\\n  display: flex;\\n  flex-direction: row;\\n  background: #FCFCFC;\\n  border-radius: 8px;\\n  width: 100%;\\n  height: 6em;\\n  box-shadow: 0px 6px 6px rgba(0, 0, 0, 0.24);\\n}\\n\\n.message-box textarea {\\n  border: 2px solid #d7e3e4;\\n  border-radius: 8px;\\n  background: #EBF8FA;\\n  width: 90%;\\n  height: 70%;\\n  margin: 0.3em;\\n  font-size: 1.4em;\\n  padding: 0.3em;\\n}\\n\\n.message-box svg {\\n  margin-left: 1em;\\n  margin-right: 1.4em;\\n  margin-top: 1.4em;\\n  cursor: pointer;\\n}\\n\\n/* RESPONSIVENESS */\\n/* Desktop */</style>\\r\\n\\r\\n<h1>CHAT</h1>\\r\\n\\r\\n<div class=\\\"chat-view\\\" id=\\\"chat-box\\\">\\r\\n    {#each chatHistory as chatMessage, i}\\r\\n        <div class=\\\"client-message\\\" >\\r\\n            <h4>{chatMessage.user}</h4>\\r\\n            <textarea rows={chatMessage.rows} cols=55 readonly wrap=\\\"soft\\\" bind:value={chatMessage.msg} />\\r\\n        </div>\\r\\n    {/each}\\r\\n</div>\\r\\n\\r\\n<div class=\\\"message-box\\\">\\r\\n    <textarea maxlength=240 id=\\\"inputbox\\\" type=\\\"text\\\" bind:value={newMessage} on:keypress={NewLine} wrap=\\\"soft\\\"/>\\r\\n    <svg xmlns=\\\"http://www.w3.org/2000/svg\\\" width=\\\"49.369\\\" height=\\\"49.384\\\" viewBox=\\\"0 0 49.369 49.384\\\" on:click={() => SendMessage()}>\\r\\n        <path id=\\\"Path_3\\\" data-name=\\\"Path 3\\\" d=\\\"M45.912.281,1.215,26.067a2.316,2.316,0,0,0,.212,4.166l10.251,4.3L39.383,10.117a.578.578,0,0,1,.829.8l-23.231,28.3v7.763a2.314,2.314,0,0,0,4.1,1.524L27.2,41.053l12.016,5.034A2.321,2.321,0,0,0,42.4,44.332L49.345,2.672A2.315,2.315,0,0,0,45.912.281Z\\\" transform=\\\"translate(-0.01 0.031)\\\" fill=\\\"#1e88e5\\\"/>\\r\\n    </svg>      \\r\\n</div>\\r\\n\"],\"names\":[],\"mappings\":\"AAgHO,QAAQ,IAAI,sEAAsE,CAAC,CAAC,AAC3F,EAAE,4BAAC,CAAC,AACF,MAAM,CAAE,CAAC,CAAC,IAAI,CACd,UAAU,CAAE,GAAG,CACf,SAAS,CAAE,IAAI,CACf,KAAK,CAAE,OAAO,AAChB,CAAC,AAED,UAAU,4BAAC,CAAC,AACV,UAAU,CAAE,OAAO,CACnB,aAAa,CAAE,GAAG,CAClB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,GAAG,CACX,aAAa,CAAE,GAAG,CAClB,UAAU,CAAE,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,CAC3C,UAAU,CAAE,MAAM,CAClB,UAAU,CAAE,MAAM,CAClB,eAAe,CAAE,OAAO,CAAC,OAAO,CAChC,cAAc,CAAE,GAAG,AACrB,CAAC,AAED,eAAe,4BAAC,CAAC,AACf,UAAU,CAAE,OAAO,CACnB,KAAK,CAAE,GAAG,CACV,UAAU,CAAE,GAAG,CACf,MAAM,CAAE,CAAC,CAAC,IAAI,CACd,UAAU,CAAE,GAAG,CACf,WAAW,CAAE,KAAK,CAClB,uBAAuB,CAAE,GAAG,CAC5B,sBAAsB,CAAE,CAAC,CACzB,yBAAyB,CAAE,GAAG,CAC9B,0BAA0B,CAAE,GAAG,CAC/B,OAAO,CAAE,KAAK,AAChB,CAAC,AAED,2CAAe,QAAQ,AAAC,CAAC,AACvB,OAAO,CAAE,EAAE,CACX,GAAG,CAAE,MAAM,CACX,IAAI,CAAE,MAAM,CACZ,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,KAAK,CACd,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,GAAG,CACX,gBAAgB,CAAE,WAAW,CAC7B,UAAU,CAAE,IAAI,CAAC,KAAK,CAAC,OAAO,CAC9B,WAAW,CAAE,IAAI,CAAC,KAAK,CAAC,WAAW,AACrC,CAAC,AAED,2CAAe,WAAW,IAAI,CAAC,AAAC,CAAC,AAC/B,UAAU,CAAE,OAAO,CACnB,KAAK,CAAE,OAAO,CACd,uBAAuB,CAAE,CAAC,CAC1B,sBAAsB,CAAE,GAAG,CAC3B,yBAAyB,CAAE,GAAG,CAC9B,0BAA0B,CAAE,GAAG,CAC/B,MAAM,CAAE,CAAC,CAAC,IAAI,CACd,UAAU,CAAE,GAAG,CACf,YAAY,CAAE,KAAK,AACrB,CAAC,AAED,2CAAe,WAAW,IAAI,CAAC,QAAQ,AAAC,CAAC,AACvC,OAAO,CAAE,EAAE,CACX,GAAG,CAAE,MAAM,CACX,IAAI,CAAE,IAAI,CACV,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,KAAK,CACd,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,GAAG,CACX,gBAAgB,CAAE,WAAW,CAC7B,UAAU,CAAE,IAAI,CAAC,KAAK,CAAC,OAAO,CAC9B,WAAW,CAAE,IAAI,CAAC,KAAK,CAAC,WAAW,CACnC,SAAS,CAAE,QAAQ,MAAM,CAAC,AAC5B,CAAC,AAED,EAAE,4BAAC,CAAC,AACF,SAAS,CAAE,KAAK,AAClB,CAAC,AAED,QAAQ,4BAAC,CAAC,AACR,SAAS,CAAE,KAAK,CAChB,WAAW,CAAE,OAAO,CACpB,MAAM,CAAE,IAAI,CACZ,MAAM,CAAE,CAAC,CACT,UAAU,CAAE,OAAO,AACrB,CAAC,AAED,6BAAe,CAAC,EAAE,cAAC,CAAC,AAClB,MAAM,CAAE,CAAC,CACT,aAAa,CAAE,KAAK,CACpB,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,MAAM,CACX,IAAI,CAAE,KAAK,AACb,CAAC,AAED,6BAAe,WAAW,IAAI,CAAC,CAAC,EAAE,cAAC,CAAC,AAClC,QAAQ,CAAE,QAAQ,CAClB,IAAI,CAAE,MAAM,AACd,CAAC,AAED,6BAAe,CAAC,QAAQ,cAAC,CAAC,AACxB,KAAK,CAAE,OAAO,CACd,MAAM,CAAE,CAAC,CACT,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,MAAM,CACX,IAAI,CAAE,KAAK,CACX,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,GAAG,AACvB,CAAC,AAED,6BAAe,WAAW,IAAI,CAAC,CAAC,QAAQ,cAAC,CAAC,AACxC,KAAK,CAAE,OAAO,CACd,QAAQ,CAAE,QAAQ,CAClB,IAAI,CAAE,GAAG,AACX,CAAC,AAED,YAAY,4BAAC,CAAC,AACZ,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,GAAG,CACnB,UAAU,CAAE,OAAO,CACnB,aAAa,CAAE,GAAG,CAClB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,GAAG,CACX,UAAU,CAAE,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,AAC7C,CAAC,AAED,0BAAY,CAAC,QAAQ,cAAC,CAAC,AACrB,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,OAAO,CACzB,aAAa,CAAE,GAAG,CAClB,UAAU,CAAE,OAAO,CACnB,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,GAAG,CACX,MAAM,CAAE,KAAK,CACb,SAAS,CAAE,KAAK,CAChB,OAAO,CAAE,KAAK,AAChB,CAAC,AAED,0BAAY,CAAC,GAAG,cAAC,CAAC,AAChB,WAAW,CAAE,GAAG,CAChB,YAAY,CAAE,KAAK,CACnB,UAAU,CAAE,KAAK,CACjB,MAAM,CAAE,OAAO,AACjB,CAAC\"}"
};
...
const Chat = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<h1 class="${"svelte-bfrt0e"}">CHAT</h1>

<div class="${"chat-view svelte-bfrt0e"}" id="${"chat-box"}">${each(chatHistory, (chatMessage, i) => `<div class="${"client-message svelte-bfrt0e"}"><h4 class="${"svelte-bfrt0e"}">${escape(chatMessage.user)}</h4>
            <textarea${add_attribute("rows", chatMessage.rows, 0)} cols="${"55"}" readonly wrap="${"soft"}" class="${"svelte-bfrt0e"}">${chatMessage.msg || ""}</textarea>
        </div>`)}</div>

<div class="${"message-box svelte-bfrt0e"}"><textarea maxlength="${"240"}" id="${"inputbox"}" type="${"text"}" wrap="${"soft"}" class="${"svelte-bfrt0e"}">${""}</textarea>
    <svg xmlns="${"http://www.w3.org/2000/svg"}" width="${"49.369"}" height="${"49.384"}" viewBox="${"0 0 49.369 49.384"}" class="${"svelte-bfrt0e"}"><path id="${"Path_3"}" data-name="${"Path 3"}" d="${"M45.912.281,1.215,26.067a2.316,2.316,0,0,0,.212,4.166l10.251,4.3L39.383,10.117a.578.578,0,0,1,.829.8l-23.231,28.3v7.763a2.314,2.314,0,0,0,4.1,1.524L27.2,41.053l12.016,5.034A2.321,2.321,0,0,0,42.4,44.332L49.345,2.672A2.315,2.315,0,0,0,45.912.281Z"}" transform="${"translate(-0.01 0.031)"}" fill="${"#1e88e5"}"></path></svg></div>`;
});
